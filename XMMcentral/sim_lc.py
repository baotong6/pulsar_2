...
def sim_LS_onesrc(path,dataname):
    ...
    for i in range(1000):
        ...
        # freq = np.arange(1 / T, 1 / 1, 1e-5)
        [FP,out_period,max_NormLSP]=hawk.get_LS(lc_out.time, lc_out.counts, freq=np.arange(1 / T, 1 / 1, 1e-6),
...
def plot_LS_sig(path,dataname,outpath=None,outname=None,save=0,show=1):
     ...
     print(sim_LSP_3sig)
     plt.figure(1, (10, 8))
     plt.plot([freq[0], freq[-1]], [FP_99, FP_99], '-',label=r'$3 \sigma~(single)$')
...
if __name__=='__main__':
    ...
    # dataname='0764191101_265.04_28.79_8692_pnsrc_2_10keV.lc'
    ...
    # sim_LS_onesrc(path, dataname=list[0])
...
'0861171201_262.75_35.14_3868_m2src_2_10keV.lc']
    dataname='0801683401_267.48_29.73_3438_pnsrc_2_10keV.lc'
    plot_LS_sig(path,dataname,outpath=path,outname=dataname[:-3],show=1,save=1)