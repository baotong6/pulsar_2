...
source_id=np.linspace(1,800,800)
...
# k_num=[1,2,3,4]
    ...
    for k in k_num:
        ...
        np.savetxt('/Users/baotong/Desktop/CDFS/fig_LS_ep{0}_ovsamp_5_baluev/LS_result_{0}.txt'.format(k),result,fmt='%10d %15.10f %15.5f %10d %10d %15.10f')
plot_CDFS_ep_LS([4])
