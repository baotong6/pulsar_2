...
def merge_result_cluster():
    ...
    #path='/Users/baotong/Desktop/period/result_NSC_merge_IG_all_obs_other500/'
    #path='/Users/baotong/Desktop/period/result_NSC_G_all_obs/'
    #path = '/Users/baotong/Desktop/period/qsub/result_G/'
    path = '/Users/baotong/Desktop/CDFS/result_all_obs_0.5_8/'

    #cand_id = np.loadtxt(path+'src_list_other500.txt')
    ...
    for i in range(23):
        ...
        if i<22:
           res = np.loadtxt(path + 'result_3h_10h_{0}_{1}.txt'.format(int(cand_id[int(i) * 20]), int(cand_id[int((i + 1) * 20 - 1)])))
        else:
           res = np.loadtxt(path + 'result_3h_10h_{0}_{1}.txt'.format(int(cand_id[int(i) * 20]),int(cand_id[-1])))
