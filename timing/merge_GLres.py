...
res=np.loadtxt(path+'result_1h_3h_{0}.txt'.format(str(srcid[0])))
...
np.savetxt(path+ 'all_result_1h_3h.txt', res, fmt='%10d %10d %10.5f %10.5f %15.5f %15.5f %15d %15.5f %15.5f %15.5f')
