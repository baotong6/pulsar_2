...
path_in='/Volumes/pulsar/SgrAGRT/merge_data/timing/'
path_out_reg='/Volumes/pulsar/SgrAGRT/merge_data/timing/region_startover/'
path_out_txt='/Volumes/pulsar/SgrAGRT/merge_data/timing/txt_startover/'
...
def main_process():
    ...
    epoch_info=np.loadtxt(path_out_txt+'SgrA_G_epoch.txt')
...
if __name__=='__main__':
    ...
    wcsimage = 'SgrAall_2000:8000.fits'
    main_process()
