...
(src_evt,epoch_info_use)=load_data(dataname='211')
period =44404.97336;net_p = 0.8
bin_len=1000.
time = src_evt[:, 0]
...
freq = freq[np.where(freq > 1 / 500000.)]
