...
def input_pars(path,specpath,srcid):
    ...
    ##--from txt--##
    (softsrc, softbkg, hardsrc, hardbkg)=input_parsfromtxt(path+'txt_startover/txt_all_obs_p90/',srcid,ebands=[2000, 6000], ebandh=[6000, 7000])
...
if __name__=='__main__':
    ...
    for i in range(3619,3619):
        input_pars(path,specpath=path,srcid=i)
