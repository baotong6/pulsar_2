...
def plot_M_dist():
    ...
    bins_p1=np.logspace(np.log10(0.1),np.log10(15),16)
    bins_p2 = np.logspace(np.log10(0.1), np.log10(10), 14)
    # plt.hist(period_lineP/3600,bins=bins_p1,histtype='step',color='grey',lw=2, linestyle='-',label='Periodic CVs')
    # plt.hist(period_nolineP/3600,bins=bins_p2,histtype='step',color='red',lw=2, linestyle='-',label='Unknown periodic sources')
